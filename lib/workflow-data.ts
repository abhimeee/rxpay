    ...
    alternativeTreatments: [
      {
        id: "alt1",
        code: "—",
        name: "IV Antibiotics + Wound Care (Conservative)",
        addresses: [
          { icdCode: "E11.52", icdDescription: "Type 2 DM with peripheral angiopathy", coverage: "partial" },
          { icdCode: "A41.9", icdDescription: "Sepsis, unspecified", coverage: "partial" },
          { icdCode: "N18.3", icdDescription: "CKD Stage 3", coverage: "none" },
        ],
        rationale: "IV broad-spectrum antibiotics (e.g., piperacillin-tazobactam) combined with daily wound care. Can control early soft tissue infection and systemic sepsis when tissue is still viable. Used as a bridge to surgical planning in haemodynamically unstable patients.",
        invasiveness: "conservative",
        caveat: "Appropriate only for early-stage infection without established gangrene. Once tissue is necrotic (gangrenous), antibiotics cannot reverse tissue death. IWGDF guidelines recommend surgical debridement for Wagner Grade ≥3. Conservative management alone risks ascending infection and above-ankle amputation.",
      },
      {
        id: "alt2",
        code: "20005",
        name: "Limited Debridement Without Amputation",
        addresses: [
          { icdCode: "E11.52", icdDescription: "Type 2 DM with peripheral angiopathy", coverage: "partial" },
          { icdCode: "A41.9", icdDescription: "Sepsis, unspecified", coverage: "partial" },
          { icdCode: "N18.3", icdDescription: "CKD Stage 3", coverage: "none" },
        ],
        rationale: "Surgical drainage of abscess/pus collection and debridement of non-viable soft tissue while preserving toe structure. Applicable when gangrenous changes are limited and the toe may still have potential for limited salvage with Doppler-confirmed residual perfusion.",
        invasiveness: "less_invasive",
        caveat: "If toe tissue is fully gangrenous and non-viable, conservation risks persistent infection and proximal spread. Foot X-ray and arterial/venous Doppler must assess vascular supply. Surgeon's intraoperative assessment of tissue viability is definitive — if toe is not salvageable, amputation proceeds.",
      },
      {
        id: "alt3",
        code: "20950",
        name: "Hyperbaric Oxygen Therapy (HBO) + Antibiotics",
        addresses: [
          { icdCode: "E11.52", icdDescription: "Type 2 DM with peripheral angiopathy", coverage: "partial" },
          { icdCode: "A41.9", icdDescription: "Sepsis, unspecified", coverage: "none" },
          { icdCode: "N18.3", icdDescription: "CKD Stage 3", coverage: "none" },
        ],
        rationale: "Adjunct therapy for diabetic foot wounds — increases tissue oxygen tension, promotes angiogenesis, and enhances antibiotic efficacy in ischaemic tissue. Evidence-based per IWGDF 2023 guidelines as an adjunct for Wagner Grade 3–4 ulcers.",
        invasiveness: "less_invasive",
        caveat: "Not available at Sri Laxmi Multispeciality Hospital; transfer required, causing dangerous delay in an emergency sepsis case. HBO is adjunct, not replacement for surgical debridement in established gangrene. Some CKD Stage 3 protocols restrict HBO due to pulmonary risks.",
      },
    ],
    requestSummary: {
      admissionType: "emergency",
      submittedWithinSLA: true,
      items: [
        { label: "Patient ID (Aadhaar)", value: "XXXX-XXXX-7682", present: true },
        { label: "Policy document", value: "POL-STAR-IND-2025-009871", present: true },
        { label: "Cashless request form (Form A)", value: "Attached — 14/02/2026, 07:55 AM", present: true },
        { label: "Treating doctor's notes", value: "Dr. S. Harinath — fever, necrotic ulcer right toe", present: true },
        { label: "Provisional diagnosis (ICD-10)", value: "E11.52, A41.9, N18.3", present: true },
        { label: "Proposed treatment", value: "Debridement + right toe amputation", present: true },
        { label: "Estimated cost breakdown", value: "₹1,65,000 (itemised)", present: true },
        { label: "Previous diabetic treatment summary", value: "Not yet provided", present: false },
      ],
    },
    timeline: [
      {
        ...
        timestamp: "2026-02-14 07:58",
        status: "done",
        detail: "Cashless pre-auth submitted by Sri Laxmi Multispeciality Hospital — emergency protocol activated.",
      },
      {
        id: "t2",
        title: "Assigned to reviewer",
        timestamp: "2026-02-14 08:10",
        status: "done",
        meta: [{ label: "Assignee", value: "Kavitha Krishnan · Medical Review Specialist" }],
      },
      {
        id: "t3",
        title: "Initial document check",
        timestamp: "2026-02-14 08:20",
        status: "done",
        detail: "Core documents verified. One item pending: previous diabetic treatment summary.",
      },
      {
        id: "t4",
        title: "Current status",
        timestamp: "2026-02-14 08:35",
        status: "current",
        detail: "Awaiting previous treatment summary from patient's GP. All other checks complete.",
      },
    ],
    eligibility: [
      { id: "e1", label: "Policy status", status: "pass", value: "Active", detail: "Policy POL-STAR-IND-2025-009871 active; no lapse on record. Premium paid up to date." },
      { id: "e2", label: "Coverage dates", status: "pass", value: "Within validity", detail: "Policy effective 2025; admission date 14/02/2026 is within the policy period." },
      { id: "e3", label: "Service coverage", status: "pass", value: "Covered — surgical", detail: "Debridement and minor amputation (toe/metatarsal) are covered surgical procedures under Star Health Comprehensive plan." },
      { id: "e4", label: "Benefit limit", status: "pass", value: "₹1.65L of ₹5L SI", detail: "Estimated ₹1,65,000 is well within the ₹5,00,000 sum insured. No applicable sub-limit for this procedure." },
      { id: "e5", label: "Pre-existing condition", status: "pass", value: "Emergency exception applies", detail: "Diabetes is a pre-existing condition; however, IRDAI emergency exception circular (CI/CIR/MISC/2020-21/154) covers life/limb-threatening complications of pre-existing conditions from day one. Gangrene with sepsis qualifies. Treatment summary requested for file completeness only." },
      { id: "e6", label: "Hospital empanelment", status: "warning", value: "Under review — provisional", detail: "Sri Laxmi Multispeciality Hospital, Hyderabad is not yet in the confirmed empanelled network. Empanelment application under review (Tier 2). Provisional clearance granted for this emergency case; settlement at actuals." },
    ],
    coding: {
      icd10: [
        {
          id: "icd1", type: "icd10", code: "E11.52",
          description: "Type 2 diabetes mellitus with diabetic peripheral angiopathy without gangrene",
          status: "missing_specificity",
          source: "hospital",
          clinicalContext: "\"Necrotic ulcer over right toe with gangrenous changes\" — Doctor's consultation notes, 14/02/2026.",
          diagnosisMatch: "E11.52 is broadly correct. Clinical notes confirm gangrenous changes — E11.51 (with gangrene) would be the more precise code and better reflects the documented severity.",
          suggestion: "Consider updating to E11.51 — Type 2 DM with diabetic peripheral angiopathy with gangrene. Gangrene is explicitly documented in the clinical notes. Using E11.51 ensures accurate severity coding and aligns with the proposed surgical procedure.",
        },
        {
          id: "icd2", type: "icd10", code: "A41.9",
          description: "Sepsis, unspecified organism",
          status: "valid",
          source: "ai",
          clinicalContext: "\"Sepsis workup ordered — provisional diagnosis includes sepsis secondary to soft tissue infection.\" — Immediate Plan, 14/02/2026.",
          diagnosisMatch: "A41.9 is appropriate at this stage. Culture results pending. May be updated to an organism-specific code once blood culture sensitivity is available.",
        },
        {
          id: "icd3", type: "icd10", code: "N18.3",
          description: "Chronic kidney disease, stage 3 (moderate)",
          status: "valid",
          source: "ai",
          clinicalContext: "\"CKD Stage 3\" listed as comorbidity in provisional diagnosis, 14/02/2026.",
          diagnosisMatch: "N18.3 is valid and appropriate. Listed correctly as a comorbidity. Relevant for antibiotic dosing adjustments.",
        },
      ],
      cpt: [
        {
          id: "cpt1", type: "cpt", code: "11043",
          description: "Debridement, muscle and/or fascia (first 20 sq cm)",
          status: "valid",
          source: "ai",
          clinicalContext: "\"Urgent wound debridement\" listed as primary procedure — consistent with standard of care for diabetic foot infection with gangrenous changes.",
          diagnosisMatch: "11043 is appropriate for deep tissue debridement in diabetic foot infection. Aligns with E11.52/E11.51 indication.",
        },
        {
          id: "cpt2", type: "cpt", code: "28810",
          description: "Amputation, metatarsal, with toe; single",
          status: "valid",
          source: "ai",
          clinicalContext: "\"Right toe amputation\" — clinical notes confirm non-viable tissue. Surgeon to assess tissue viability intraoperatively.",
          diagnosisMatch: "28810 is the correct CPT for right toe / transmetatarsal amputation in diabetic foot gangrene. AI-suggested based on operative plan in consultation notes.",
        },
        {
          id: "cpt3", type: "cpt", code: "99223",
          description: "Initial hospital care, high complexity medical decision-making",
          status: "valid",
          source: "ai",
          clinicalContext: "Emergency admission with sepsis, gangrene, uncontrolled T2DM, and CKD — meets criteria for high complexity MDM.",
          diagnosisMatch: "99223 is correct for high-complexity emergency inpatient admission. Multi-system involvement justifies this level.",
        },
      ],
    },
    medicalNecessity: [
      { id: "mn1", level: 1, source: "IRDAI Clinical Guidelines 2024", finding: "Surgical debridement with amputation is the IRDAI-approved standard of care for diabetic foot infection with gangrenous changes. Emergency cashless approval applicable per IRDAI guidelines on life/limb-threatening emergencies.", status: "met" },
      { id: "mn2", level: 2, source: "Star Health Surgical Policy, Section 4.2", finding: "Debridement and minor amputations (toe/metatarsal) are covered under surgical benefit. Emergency override clause applies for sepsis risk. Documentation is complete.", status: "met" },
      { id: "mn3", level: 3, source: "IWGDF Risk Classification 2023", finding: "Estimated PEDIS Score 4–5: perfusion impaired, >3cm extent, deep infection with bone involvement, systemic sepsis markers, neuropathy present. Score ≥4 mandates urgent surgical evaluation per IWGDF 2023 guidelines.", status: "met" },
      { id: "mn4", level: 4, source: "ADA Standards of Medical Care in Diabetes, 2025", finding: "ADA recommends urgent surgical consultation for diabetic foot ulcers with wet gangrene and systemic infection. Delay significantly increases risk of above-ankle amputation and mortality.", status: "met" },
      { id: "mn5", level: 5, source: "Treating Surgeon — Dr. S. Harinath, General Surgery", finding: "\"Non-viable gangrenous tissue on right toe confirmed on examination. Immediate debridement and amputation required to prevent ascending infection. Patient at imminent risk of above-ankle amputation if intervention is delayed.\"", status: "met" },
    ],
    ...
    medicalNecessityInsights: [
      {
        ...
        diagnosisDescription: "T2DM with diabetic peripheral angiopathy with gangrene",
        procedureCode: "11043",
        procedureDescription: "Debridement, muscle/fascia",
        irdaApproved: true,
        policyApproved: true,
        aiSimilarityPct: 91,
        aiSummary: "91% of similar diabetic gangrene cases with sepsis were approved for surgical debridement. Emergency presentation with systemic signs is the strongest approval indicator.",
        sourceUrl: "https://www.iwgdfguidelines.org/",
        sourceLabel: "IWGDF Guidelines",
      },
      {
        id: "mni2",
        diagnosisCode: "A41.9",
        diagnosisDescription: "Sepsis, unspecified",
        procedureCode: "99223",
        procedureDescription: "Initial hospital care, high complexity",
        irdaApproved: true,
        policyApproved: true,
        aiSimilarityPct: 94,
        aiSummary: "Sepsis with multi-system involvement (diabetes + CKD) is consistently approved for high-complexity inpatient care. No comparable case rejections found.",
        sourceUrl: "https://www.irdai.gov.in/",
        sourceLabel: "IRDAI Evidence",
      },
      {
        id: "mni3",
        diagnosisCode: "N18.3",
        diagnosisDescription: "CKD Stage 3 (comorbidity)",
        procedureCode: "28810",
        procedureDescription: "Amputation, metatarsal with toe",
        irdaApproved: true,
        policyApproved: true,
        aiSimilarityPct: 85,
        aiSummary: "CKD as a comorbidity does not preclude approval. 85% of diabetic foot amputations with CKD listed as comorbidity were approved without additional requirements.",
        sourceUrl: "https://pubmed.ncbi.nlm.nih.gov/",
        sourceLabel: "Clinical Evidence",
      },
    ],
    fraudFlags: [
      {
        ...
        category: "provider",
        severity: "low",
        description: "Sri Laxmi Multispeciality Hospital is not yet in the confirmed empanelled network — empanelment application under review. No prior fraud history on record. Provisional clearance granted for this emergency case.",
        providerFraudRate: 0.4,
      },
      {
        id: "f2",
        category: "patient",
        severity: "none",
        description: "No anomalies detected in patient claim history. First claim under this policy. Diagnosis and treatment are consistent with the documented clinical presentation.",
        patientClaimsCount: 1,
      },
    ],
    queries: [
      {
        id: "q1",
        question: "Please share a brief treatment summary from the patient's GP or physician covering prior diabetic management. This is needed to complete the pre-existing condition record for the emergency exception filing — not expected to affect approval.",
        status: "open",
        dueDate: "2026-02-18",
      },
    ],
